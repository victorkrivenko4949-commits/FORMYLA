...
✅ МАТЕМАТИЧЕСКИЙ МЕТОД остался тем же
✅ СЛОЖНОСТЬ осталась той же (для {grade} класса)
✅ Тип ответа остался тем же
❌ ВСЕ числа заменены на другие (но ответ красивый)
❌ ВСЕ персонажи заменены (используй: Петя, Вася, Маша, Аня, Коля, Даша)
❌ Контекст полностью другой
❌ Формулировка переписана своими словами
❌ Задача НЕ ГУГЛИТСЯ — никаких уникальных фраз из оригинала

🚫 ЗАПРЕЩЕНЫ сказочные персонажи (Алиса, Шляпник, Буратино, Незнайка и т.д.)
✅ Используй обычные русские имена.
