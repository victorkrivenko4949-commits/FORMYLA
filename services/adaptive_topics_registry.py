...
Данные сверены с аудитом БД (см. `scripts/_audit_topics_per_grade.py`).
В каждом классе ровно 7 тем, у каждой темы ≥ 96 задач.
    ...
    8: [
        {
            ...
            'emoji': '🧮',
            'db_topic': 'Квадратные уравнения и теорема Виета',
        },
        {
            'key': 'inequalities_transformations',
            'name': 'Неравенства и преобразования',
            'emoji': '≷',
            'db_topic': 'Неравенства и преобразования',
        },
        {
            'key': 'functions_graphs',
            'name': 'Функции и графики',
    ...
    9: [
        {
            ...
            'emoji': '🧮',
            'db_topic': 'Квадратные уравнения, Виет, параметры',
            # Старые названия тем 9-го класса в прод-БД (до унификации
            # реестра 2026-05). Локально уже переименованы — но в проде
            # `class_level=9` ещё хранится со старыми строками. Маппим их,
            # чтобы не трогать БД.
            'aliases': [
        ...
        {
            'key': 'systems_modulus_radicals',
            'name': 'Системы, модули, радикалы, неравенства',
            'emoji': '≷',
            'db_topic': 'Системы, модули, радикалы, неравенства',
            'aliases': [
                'Неравенства',
            ],
        },
        {
            ...
            'emoji': '📐',
            'db_topic': 'Геометрия треугольника и окружности',
            'aliases': [
                'Треугольники',
                'Начала геометрии',
        ...
        },
        {
            ...
            'emoji': '🧠',
            'db_topic': 'Логика, инварианты, стратегии',
            'aliases': [
                'Логика и инварианты',
            ],
        },
        {
            'key': 'functions_sequences_olympiad',
            'name': 'Функции, последовательности и олимпиадные конструкции',
            'emoji': '📈',
            'db_topic': 'Функции, последовательности и олимпиадные конструкции',
            'aliases': [
                'Функции и графики',
                'Задачи на движение',
            ],
    ...
    11: [
        {
            ...
            'emoji': '🟦',
            'db_topic': 'Стереометрия, координаты и векторы',
        },
        {
            'key': 'functions_graphs_parameters',
            'name': 'Функции, графики и параметры',
            'emoji': '📈',
            'db_topic': 'Функции, графики и параметры',
        },
        {
            'key': 'inequalities_estimates',
            'name': 'Неравенства и оценки',
            'emoji': '≷',
            'db_topic': 'Неравенства и оценки',
        },
        {
            'key': 'trigonometry_mixed_equations',
            'name': 'Тригонометрия и смешанные уравнения',
            'emoji': '📐',
            'db_topic': 'Тригонометрия и смешанные уравнения',
        },
        {
            'key': 'polynomials_sequences_functional',
            'name': 'Многочлены, последовательности, функциональные уравнения',
            'emoji': '🧮',
            'db_topic': 'Многочлены, последовательности, функциональные уравнения',
        },
        {
            'key': 'number_theory_diophantine',
            'name': 'Теория чисел и диофантовы задачи',
            'emoji': '🔢',
            'db_topic': 'Теория чисел и диофантовы задачи',
        },
        {
            'key': 'combinatorics_graphs_logic',
            'name': 'Комбинаторика, графы, логика',
            'emoji': '🎲',
            'db_topic': 'Комбинаторика, графы, логика',
        },
    ],
}
