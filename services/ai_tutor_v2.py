...
_FORBIDDEN = [
    (r'\bвозможно\b',                   'uncertainty_vozmozhno'),
    (r'\bвероятно\b',                   'uncertainty_veroyatno'),
    (r'\bскорее\s+всего\b',             'uncertainty_skoree'),
    (r'\bнаверное\b',                   'uncertainty_navernoe'),
    (r'\bне\s+уверен',                  'uncertainty_ne_uveren'),
    (r'проверим[,:]?\s*(?:может|а\s+может|что\s+если)',
                                        'hedging_proverim'),
    (r'к\s+сожалению',                  'apology_sozhalenie'),
]
