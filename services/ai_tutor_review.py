...
SYSTEM_PROMPT_PROOF = (
    "Ты — проверяющий математических доказательств платформы FORMYLA.net.\n\n"
...
SYSTEM_PROMPT_NUMERIC = (
    "Ты — проверяющий математических задач платформы FORMYLA.net.\n"
...
def score_badge(
    ...
    """Бейдж результата для UI (FORMYLA.net v2: шкала +1 / 0 / −1).
...
def review_attempt(
    *,
    ...
    if not proof_mode:
        ...
        # решения всё равно должен приносить баллы (требование FORMYLA.net).
    ...
    # 6) Префикс с явной оценкой (FORMYLA.net v2: +1/0/−1)
...
SOLVE_SYSTEM_PROMPT = (
    "Ты — AI-репетитор платформы FORMYLA.net. Реши математическую задачу ПОЛНОСТЬЮ "
