...
6. ФОРМАТ ОТВЕТА (format_valid):
   ...
   ТРИГГЕРЫ для format_valid = 1:
   - В условии встречается ЛЮБОЙ из глаголов:
     "докажите", "покажите", "обоснуйте", "установите",
     "проверьте что", "верно ли", "является ли"
   - Ответ = "да"/"нет"/"верно"/"существует"/текстовое обоснование

   ТРИГГЕР для format_valid = 7:
   - Ответ — множество конкретных значений (например: "1, 2, 5")

   ТРИГГЕР для format_valid = 10:
   - Ответ — конкретное число или математическое выражение
