...
ROLE_DEFAULT_MODEL = {
    ...
    # CH-aux: решатель.  gpt-5.4 через OdiRouter — быстрый (~24s), строит
    # полные доп. построения (биссектрисы, инцентр, вписанную окружность)
    # и не упирается в 504-таймаут nginx, как gpt-5.5/gpt-5.6-sol.
    "solver": "gpt-5.4",
