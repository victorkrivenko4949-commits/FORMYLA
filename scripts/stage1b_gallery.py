# -*- coding: utf-8 -*-
"""CH30 ЭТАП 1b: галерея output/stage1b/gallery.html (фон #0F1729)."""
import io
import json
import os
import sys
...
_OUT = os.path.join(_ROOT, "output", "stage1b")
...
def main():
    ...
    parts = ["""<!DOCTYPE html>
<html lang="ru">
<head><meta charset="utf-8"><title>CH30 stage1b</title>
<style>
...
<h1>CH30 ЭТАП 1b — автовывод семантики</h1>
<div class="sub">Фон #0F1729 · base/aux парами · авто right_angle_mark + visual_role</div>
<div class="grid">
"""]
    for c in cards:
...
<div class="card">
  ...
  <div class="pair">
    ...
    print(f"[stage1b] gallery: {out} ({len(cards)} cards)")
