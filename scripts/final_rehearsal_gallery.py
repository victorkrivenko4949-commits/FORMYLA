# -*- coding: utf-8 -*-
"""CH29: тёмная галерея base/aux для финальной репетиции."""
import io
import json
import os
import sys
...
def main():
    ...
    for r in results["rows"]:
        if not (r["base_path"] or r["aux_path"]):
            continue
        uid = r["task_uid"]
        base = ""
        aux = ""
    ...
    parts = ["""<!DOCTYPE html>
<html lang="ru">
<head><meta charset="utf-8"><title>CH29 final rehearsal</title>
<style>
...
<h1>CH29 final rehearsal — gallery</h1>
<div class="sub">Фон #0F1729 · base/aux парами</div>
<div class="grid">
"""]
    for c in cards:
...
<div class="card">
  ...
  <div class="pair">
    ...
    print(f"[ch29] gallery: {out} ({len(cards)} cards)")
