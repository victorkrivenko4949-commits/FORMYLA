"""One-shot helper: write the full static/js/wb_call.js file.

Running this script produces the 1-to-1 WebRTC client used by the whiteboard.
Kept as a Python file because pasting ~500 lines of JS through tool calls
proved unreliable (truncations).  Run once and forget:

    python scripts/_write_wb_call_js.py
"""
...
JS = r"""// FORMYLA Whiteboard - 1-to-1 video call panel.
...
OUT = Path(__file__).resolve().parent.parent / "static" / "js" / "wb_call.js"
