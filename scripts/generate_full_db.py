...
<draft>
Здесь ты пошагово:
1. Придумываешь задачу, соответствующую классу, теме и уровню сложности
2. Решаешь её сам полностью
3. Проверяешь все вычисления
4. Убеждаешься, что ответ получается красивым и логичным
5. Проверяешь, что задача соответствует указанному шагу прогрессии сложности
</draft>
